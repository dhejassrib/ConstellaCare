...
//         {/* Interactive Topbar */}
//         <header className="sticky top-0 bg-slate-900/80 backdrop-blur-md py-4 px-6 md:px-10 flex items-center justify-between border-b border-[#6366f1]/10 z-20">
//           <div className="flex items-center gap-3">
//             <button 
//               onClick={() => setSidebarOpen(true)}
//               className="md:hidden p-2 bg-slate-850 rounded-xl cursor-pointer"
//             >
//               <Compass className="w-5 h-5 text-purple-600" />
//             </button>
//             <h1 className="text-lg font-bold bg-gradient-to-r from-slate-100 to-slate-350 bg-clip-text text-transparent">
//               {getSectionTitle()}
//             </h1>
//           </div>
...
//             <div className="flex items-center gap-1.5 bg-purple-100 border border-purple-500/20 px-3 py-1 rounded-full text-xs font-bold text-purple-600 dark:text-purple-400">
//               <Star className="w-3.5 h-3.5 fill-purple-500 animate-pulse" />
...
//               className="p-2 bg-slate-850 hover:bg-slate-100 dark:hover:bg-slate-800 text-purple-600 dark:text-purple-400 rounded-xl transition cursor-pointer"
...
//                       {view === 'caregiver' ? 'Good evening, Caregiver 🌟' : 'Good evening, Sarah ✨'}
//                     </h2>
//                     <p className="text-xs text-slate-350 max-w-md mt-1 leading-relaxed">
//                       {view === 'caregiver' 
//                         ? "Sarah's Constellation index has flared brighter this week. Let's make sure her care journey is fully supported."
        ...
        <header className="sticky top-0 bg-[#FAF8FD]/85 dark:bg-slate-900/80 backdrop-blur-md py-4 px-6 md:px-10 flex items-center justify-between border-b border-purple-200/50 dark:border-[#6366f1]/10 z-20">
          ...
          <div className="flex items-center gap-3.5">
            ...
            {user ? (
              ...
              <button
                onClick={() => triggerMilestoneAuth("Enrolling encrypted cloud sync coordinates", "topbar_sync")}
